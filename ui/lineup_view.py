...
class LineupView(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.away_box = QGroupBox("Away Lineup")
        self.home_box = QGroupBox("Home Lineup")
    ...
    def set_game(self, detail: GameDetail) -> None:
        self.away_box.setTitle(f"{detail.away.name} Lineup")
        self.home_box.setTitle(f"{detail.home.name} Lineup")
    ...
    def _fill(
        ...
        batting_label = QLabel("Batting Order")
        batting_label.setObjectName("subtitle")
        layout.addWidget(batting_label)
        if not players:
            label = QLabel("Lineup has not been posted yet.")
        ...
        pitching_label = QLabel("Pitchers Used")
        pitching_label.setObjectName("subtitle")
        layout.addWidget(pitching_label)
        if not pitchers:
            label = QLabel("No pitcher has appeared in the box score yet.")
            label.setObjectName("subtitle")
            layout.addWidget(label)
